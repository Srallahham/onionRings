...
-- Dumping data for table onionrings.album: ~0 rows (approximately)
...
-- Dumping data for table onionrings.member: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `recipe` (
  ...
  UNIQUE KEY `recipe_title_UNIQUE` (`recipe_title`),
...
-- Dumping data for table onionrings.recipe: ~0 rows (approximately)
...
-- Dumping structure for table onionrings.user
...
-- Dumping data for table onionrings.user: ~0 rows (approximately)
